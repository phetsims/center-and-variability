...
const CenterAndVariabilityFluent = {
  "center-and-variability": {
    ...
    titleStringProperty: _.get( CenterAndVariabilityStrings, 'center-and-variability.titleStringProperty' )
  },
  screen: {
    _comment_0: new FluentComment( {"comment":"screen names","associatedKey":"screen.median"} ),
    medianStringProperty: _.get( CenterAndVariabilityStrings, 'screen.medianStringProperty' ),
    meanAndMedianStringProperty: _.get( CenterAndVariabilityStrings, 'screen.meanAndMedianStringProperty' ),
    variabilityStringProperty: _.get( CenterAndVariabilityStrings, 'screen.variabilityStringProperty' )
  },
  ...
  distanceInMetersAccordionBoxTitleStringProperty: _.get( CenterAndVariabilityStrings, 'distanceInMetersAccordionBoxTitleStringProperty' ),
  distanceInMetersChartLabelStringProperty: _.get( CenterAndVariabilityStrings, 'distanceInMetersChartLabelStringProperty' ),
  ...
  meanEqualsUnknownStringProperty: _.get( CenterAndVariabilityStrings, 'meanEqualsUnknownStringProperty' ),
  ...
  medianEqualsUnknownStringProperty: _.get( CenterAndVariabilityStrings, 'medianEqualsUnknownStringProperty' ),
  ...
  plotTypeStringProperty: _.get( CenterAndVariabilityStrings, 'plotTypeStringProperty' ),
  dotPlotStringProperty: _.get( CenterAndVariabilityStrings, 'dotPlotStringProperty' ),
  linePlotStringProperty: _.get( CenterAndVariabilityStrings, 'linePlotStringProperty' ),
  medianStringProperty: _.get( CenterAndVariabilityStrings, 'medianStringProperty' ),
  meanStringProperty: _.get( CenterAndVariabilityStrings, 'meanStringProperty' ),
  meanEqualsStringProperty: _.get( CenterAndVariabilityStrings, 'meanEqualsStringProperty' ),
  valueUnknownStringProperty: _.get( CenterAndVariabilityStrings, 'valueUnknownStringProperty' ),
  metersStringProperty: _.get( CenterAndVariabilityStrings, 'metersStringProperty' ),
  meterStringProperty: _.get( CenterAndVariabilityStrings, 'meterStringProperty' ),
  needAtLeastFiveKicksStringProperty: _.get( CenterAndVariabilityStrings, 'needAtLeastFiveKicksStringProperty' ),
  maxKicksStringProperty: _.get( CenterAndVariabilityStrings, 'maxKicksStringProperty' ),
  maxKicksDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'maxKicksDescriptionStringProperty' ),
  outliersStringProperty: _.get( CenterAndVariabilityStrings, 'outliersStringProperty' ),
  outliersDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'outliersDescriptionStringProperty' ),
  valueKicksPatternStringProperty: _.get( CenterAndVariabilityStrings, 'valueKicksPatternStringProperty' ),
  pointerStringProperty: _.get( CenterAndVariabilityStrings, 'pointerStringProperty' ),
  _comment_1: new FluentComment( {"comment":"median strings","associatedKey":"medianQuestion"} ),
  medianQuestionStringProperty: _.get( CenterAndVariabilityStrings, 'medianQuestionStringProperty' ),
  sortDataStringProperty: _.get( CenterAndVariabilityStrings, 'sortDataStringProperty' ),
  youSortedTheDataStringProperty: _.get( CenterAndVariabilityStrings, 'youSortedTheDataStringProperty' ),
  medianDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'medianDescriptionStringProperty' ),
  _comment_2: new FluentComment( {"comment":"mean and median strings","associatedKey":"meanAndMedianQuestion"} ),
  meanAndMedianQuestionStringProperty: _.get( CenterAndVariabilityStrings, 'meanAndMedianQuestionStringProperty' ),
  meanDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'meanDescriptionStringProperty' ),
  _comment_3: new FluentComment( {"comment":"variability strings","associatedKey":"variabilityQuestion"} ),
  variabilityQuestionStringProperty: _.get( CenterAndVariabilityStrings, 'variabilityQuestionStringProperty' ),
  iqrEqualsValueMPatternStringProperty: _.get( CenterAndVariabilityStrings, 'iqrEqualsValueMPatternStringProperty' ),
  iqrEqualsUnknownStringProperty: _.get( CenterAndVariabilityStrings, 'iqrEqualsUnknownStringProperty' ),
  rangeEqualsValueMPatternStringProperty: _.get( CenterAndVariabilityStrings, 'rangeEqualsValueMPatternStringProperty' ),
  rangeEqualsUnknownStringProperty: _.get( CenterAndVariabilityStrings, 'rangeEqualsUnknownStringProperty' ),
  madEqualsValueMPatternStringProperty: _.get( CenterAndVariabilityStrings, 'madEqualsValueMPatternStringProperty' ),
  madEqualsUnknownStringProperty: _.get( CenterAndVariabilityStrings, 'madEqualsUnknownStringProperty' ),
  madEqualsStringProperty: _.get( CenterAndVariabilityStrings, 'madEqualsStringProperty' ),
  rangeStringProperty: _.get( CenterAndVariabilityStrings, 'rangeStringProperty' ),
  interquartileRangeIQRStringProperty: _.get( CenterAndVariabilityStrings, 'interquartileRangeIQRStringProperty' ),
  iqrStringProperty: _.get( CenterAndVariabilityStrings, 'iqrStringProperty' ),
  minStringProperty: _.get( CenterAndVariabilityStrings, 'minStringProperty' ),
  maxStringProperty: _.get( CenterAndVariabilityStrings, 'maxStringProperty' ),
  q1StringProperty: _.get( CenterAndVariabilityStrings, 'q1StringProperty' ),
  q3StringProperty: _.get( CenterAndVariabilityStrings, 'q3StringProperty' ),
  meanAbsoluteDeviationMADStringProperty: _.get( CenterAndVariabilityStrings, 'meanAbsoluteDeviationMADStringProperty' ),
  madStringProperty: _.get( CenterAndVariabilityStrings, 'madStringProperty' ),
  intervalToolStringProperty: _.get( CenterAndVariabilityStrings, 'intervalToolStringProperty' ),
  predictMeanStringProperty: _.get( CenterAndVariabilityStrings, 'predictMeanStringProperty' ),
  predictMedianStringProperty: _.get( CenterAndVariabilityStrings, 'predictMedianStringProperty' ),
  rangeDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'rangeDescriptionStringProperty' ),
  iqrDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'iqrDescriptionStringProperty' ),
  dataValuesInMetersStringProperty: _.get( CenterAndVariabilityStrings, 'dataValuesInMetersStringProperty' ),
  ...
  madDescriptionStringProperty: _.get( CenterAndVariabilityStrings, 'madDescriptionStringProperty' ),
  ...
  keyboardHelpDialog: {
    ...
    moveStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.moveStringProperty' ),
    endOfNumberLineStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.endOfNumberLineStringProperty' ),
    startOfNumberLineStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.startOfNumberLineStringProperty' ),
    grabOrReleaseBallStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.grabOrReleaseBallStringProperty' ),
    moveGrabbedBallTitleStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.moveGrabbedBallTitleStringProperty' ),
    moveGrabbedBallStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.moveGrabbedBallStringProperty' ),
    grabOrReleaseStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.grabOrReleaseStringProperty' ),
    jumpToStartOfNumberLineStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.jumpToStartOfNumberLineStringProperty' ),
    jumpToEndOfNumberLineStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.jumpToEndOfNumberLineStringProperty' ),
    jumpBallToTickMarkStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.jumpBallToTickMarkStringProperty' ),
    moveInLargerStepsStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.moveInLargerStepsStringProperty' ),
    _comment_1: new FluentComment( {"comment":"Content for the Median screen.","associatedKey":"medianScreen"} ),
    medianScreen: {
      grabOrReleaseBallOrCardStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.grabOrReleaseBallOrCardStringProperty' ),
      movePredictMedianStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.movePredictMedianStringProperty' ),
      predictMedianStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.predictMedianStringProperty' ),
      moveGrabbedBallOrCardTitleStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.moveGrabbedBallOrCardTitleStringProperty' ),
      moveGrabbedBallOrCardStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.moveGrabbedBallOrCardStringProperty' ),
      jumpToStartOfCardsOrNumberLineStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.jumpToStartOfCardsOrNumberLineStringProperty' ),
      jumpToEndOfCardsOrNumberLineStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.medianScreen.jumpToEndOfCardsOrNumberLineStringProperty' )
    },
    _comment_2: new FluentComment( {"comment":"Content for the Mean and Median screen.","associatedKey":"meanAndMedianScreen"} ),
    meanAndMedianScreen: {
      movePredictMeanOrMedianStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.meanAndMedianScreen.movePredictMeanOrMedianStringProperty' ),
      movePredictionPointerStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.meanAndMedianScreen.movePredictionPointerStringProperty' ),
      movePredictMeanInSmallerStepsStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.meanAndMedianScreen.movePredictMeanInSmallerStepsStringProperty' ),
      moveInLargerStepsStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.meanAndMedianScreen.moveInLargerStepsStringProperty' )
    },
    _comment_3: new FluentComment( {"comment":"Content for the Variability screen.","associatedKey":"variabilityScreen"} ),
    variabilityScreen: {
      movePointerIntervalHandleOrIntervalBlockStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.variabilityScreen.movePointerIntervalHandleOrIntervalBlockStringProperty' ),
      objectStringProperty: _.get( CenterAndVariabilityStrings, 'keyboardHelpDialog.variabilityScreen.objectStringProperty' )
    }
  },
