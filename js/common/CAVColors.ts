...
const CAVColors = {
  ...
  intervalToolIconShadedSphereMainColorProperty: new ProfileColorProperty( centerAndVariability, 'intervalToolIconShadedSphereMainColor', { default: new Color( '#fdf581' ).withAlpha( 0.75 ) } ),
